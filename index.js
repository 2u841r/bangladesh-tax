...
const check2 = () => {
  if (aay > step1Taka) {
    ...
    aay<step2Taka ? korjoggoAay2 = aay - step1Taka : korjoggoAay2 = step2Taka - step1Taka;
...
const check3 = () => {
  if (aay > step2Taka) {
    aay<step3Taka ? korjoggoAay3 = aay - step2Taka : korjoggoAay3 = step3Taka - step2Taka;
...
const check4 = () => {
  if (aay > step3Taka) {
    aay<step4Taka ? korjoggoAay4 = aay - step3Taka : korjoggoAay4 = step4Taka - step3Taka;
...
const check5 = () => {
  if (aay > step4Taka) {
    aay<step5Taka ? korjoggoAay5 = aay - step4Taka : korjoggoAay5 = step5Taka - step4Taka;
